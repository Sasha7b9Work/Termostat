...
public: /* data */ 
	...
	bool setComponentValue(String component, int value);
	
	bool setComponentText(String component, String txt);
	
	uint16_t getComponentText(String component);    
	
	bool init(const char* pageId, bool first);
    /*
     * Receive string data. 
     * 
     ...
     *
     */   
    uint16_t recvRetString(String &string, uint32_t timeout = 500, uint8_t nr_of_FF_bytes = 0, bool recv_flag = false);
